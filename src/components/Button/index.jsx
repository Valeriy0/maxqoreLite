...
const typesClasses = {
  ...
  'light-white-bordered': 'px-5 py-3 bg-transparent border-2 border-white-100 hover:bg-white-300',
  ...
  'bell-purple-circle': 'px-0 py-0 bg-bell-purple rounded-full w-10 h-10 hover:bg-bell-purple active:bg-bell-purple',
  ...
  'white-blue': 'py-3 px-5 text-main-blue  bg-white-900 hover:bg-main-blue hover:text-white',
  ...
  addSocialBlue:
    '!font-normal text-white border border-main-blue !px-5 !py-1 rounded-mini bg-main-blue-200 hover:bg-main-blue-500 active:bg-main-blue',
  contest: 'px-5 py-2 !font-medium text-white rounded-mini bg-[#FFB900] hover:bg-[#FFB920] active:bg-main-blue',
};
...
const Button = ({ type, className, buttonType, children, disabled, ...props }) => {
  const totalClassName = disabled && type !== 'transparent' ? typesClasses['disabled'] : typesClasses[type];
